          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <!-- Updated Delete Link to Include product=del -->
                  <a href="product_db.php?product=del&p_id=<?php echo $row_product['p_id']; ?>" class="del-btn btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                </td>
              </tr>
              <?php
